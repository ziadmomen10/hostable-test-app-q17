...
import type { V2JobPostCtaSectionData } from '@/types/newSectionTypes';
import type { BaseSectionData } from '@/types/baseSectionTypes';

interface Props {
  data: V2JobPostCtaSectionData & BaseSectionData;
  onChange: (data: V2JobPostCtaSectionData & BaseSectionData) => void;
}

export function V2JobPostCtaSettingsContent({ data, onChange }: Props) {
...
export default V2JobPostCtaSettingsContent;
