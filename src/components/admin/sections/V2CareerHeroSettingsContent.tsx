...
import type { V2CareerHeroSectionData } from '@/types/newSectionTypes';
import type { BaseSectionData } from '@/types/baseSectionTypes';

interface Props {
  data: V2CareerHeroSectionData & BaseSectionData;
  onChange: (data: V2CareerHeroSectionData & BaseSectionData) => void;
}

export function V2CareerHeroSettingsContent({ data, onChange }: Props) {
...
export default V2CareerHeroSettingsContent;
