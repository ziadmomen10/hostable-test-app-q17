...
import type { V2CareerCta3SectionData } from '@/types/newSectionTypes';
import type { BaseSectionData } from '@/types/baseSectionTypes';

interface Props {
  data: V2CareerCta3SectionData & BaseSectionData;
  onChange: (data: V2CareerCta3SectionData & BaseSectionData) => void;
}

export function V2CareerCta3SettingsContent({ data, onChange }: Props) {
...
export default V2CareerCta3SettingsContent;
