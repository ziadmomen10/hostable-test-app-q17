...
import type { V2JobFaqSectionData } from '@/types/newSectionTypes';
import type { BaseSectionData } from '@/types/baseSectionTypes';

interface Props {
  data: V2JobFaqSectionData & BaseSectionData;
  onChange: (data: V2JobFaqSectionData & BaseSectionData) => void;
}

export function V2JobFaqSettingsContent({ data, onChange }: Props) {
...
export default V2JobFaqSettingsContent;
