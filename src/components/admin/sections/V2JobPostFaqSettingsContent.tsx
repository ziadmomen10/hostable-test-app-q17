...
import type { V2JobPostFaqSectionData } from '@/types/newSectionTypes';
import type { BaseSectionData } from '@/types/baseSectionTypes';

interface Props {
  data: V2JobPostFaqSectionData & BaseSectionData;
  onChange: (data: V2JobPostFaqSectionData & BaseSectionData) => void;
}

export function V2JobPostFaqSettingsContent({ data, onChange }: Props) {
...
export default V2JobPostFaqSettingsContent;
