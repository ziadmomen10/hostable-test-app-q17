...
interface V2CareerCtaSectionProps {
  data?: {
    badgeIcon?: string;
    badgeText?: string;
    title?: string;
...
export const V2CareerCtaSection: React.FC<V2CareerCtaSectionProps> = ({ data, sectionId }) => {
  const badgeIcon = data?.badgeIcon ?? 'https://c.animaapp.com/2X7idWIf/img/icon.svg';
  ...
  return (
    <section
      ...
      aria-labelledby="v2-career-cta-heading"
    >
      {/* Decorative blurs */}
      ...
      <div className="relative z-10 w-full max-w-[1920px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8 py-16 md:py-[120px] px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24 2xl:px-[120px]">
        ...
        >
          ...
          <img className="w-5 h-5" alt="" src="https://c.animaapp.com/2X7idWIf/img/icon-1.svg" aria-hidden="true" />
        </a>
      </div>
    </section>
  );
...
export default V2CareerCtaSection;
